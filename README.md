...
* cut_X: A folder that is done for each SNP cut off chosen. 
 * Allele_alignments: containing BAM files containing reads with variants marked as: *alleleA*, *alleleB*, *ref*,  *ambiguous* and *_cutoff_*
